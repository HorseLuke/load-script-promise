...
function checkOption(option, id){
    ...
    if(!Object.prototype.hasOwnProperty.call(option, "src")){
        throw new Error("Specific provider options does not have src value. Resource id is " + id);
    }
    ...
    do{
        ...
        throw new Error("Specific provider options must have 'windowKey' value or 'detectProvider' anonymous function. Resource id is " + id);
