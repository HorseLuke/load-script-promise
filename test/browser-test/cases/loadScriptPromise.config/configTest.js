describe('loadScriptPromise.config Test', async function() {
    ...
    it('is get all config values in Module config', function(done) {
        const d = loadScriptPromise.config.get();
        done(typeof d === "object" ? null : new Error("get all config values failed"));
    });


    it('is set one value in Module config', function(done) {
    ...
    it('is set object values in Module config', function(done) {
